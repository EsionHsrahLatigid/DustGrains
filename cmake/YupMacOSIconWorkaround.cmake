# YUP commit 9a1c9bc generates an iconset that iconutil rejects on some
# current macOS installs. The same source PNG converts successfully when sips
# writes ICNS directly, so override only the private conversion hook.

find_program(DUSTGRAINS_SIPS_EXECUTABLE sips REQUIRED)
...
function(_yup_convert_png_to_icns png_path icons_path output_variable)
    ...
    execute_process(
        COMMAND "${DUSTGRAINS_SIPS_EXECUTABLE}"
